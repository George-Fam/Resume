...
\begin{document}
  ...
  \begin{resume_list}
    ...
    \begin{itemize}
        \item INF2120 — Programming II (Été 2025)
  ...
  \headingBf{Senior Customer Service Representative}{July 2018 -- July 2020}
  ...
  \begin{resume_list}
    \item Develop the video game \textit{Circles}, inspired by \textit{Super Hexagon}, using the SDL2 library for graphic programming and animation
    \vspace{2pt}
