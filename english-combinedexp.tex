...
\begin{document}
  ...
  \begin{resume_list}
    ...
    \end{itemize}
    \itemTitle{Animation d'Ateliers}
  ...
  \headingBf{Senior Customer Service Representative}{Juil. 2018 -- Juil. 2020}
  ...
  \headingBf{INF3135 (oftware Construction and Maintenance)}{C, Bash, BATS}
  \begin{resume_list}
