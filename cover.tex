...
\companyInfo{COMPANY NAME}{CONTACT NAME/TITLE}{ADDR}{CITY/STATE}
\object{SUBJECT}
\content{
  Dear CONTACT, \\
  
  \lipsum[1-1] \\
}{I look forward to discuss the position and what I can do for your company.}
\signature
\includegraphics[height=3\baselineskip]{signature} \par
\end{document}
