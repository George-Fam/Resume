...
\begin{document}
  ...
  \begin{resume_list}
    ...
    \item Encadrement pratique des étudiants lors des séances de laboratoire, explication de concepts et aide technique individualisée.
    \begin{itemize}
  ...
  \vspace{3pt}
    ...
    \item Correction rigoureuse d’examens selon les barèmes fournis par l’enseignant.
    \begin{itemize}
