...
\begin{resume_list}
\item Conception et implémentation d’un émulateur pour un robot virtuel 
	\vspace{2pt}
\item Développement de fonctionnalités pour un jeu de type Tower Defense 
	\vspace{2pt}
...
\headingBf{Animateur d’atelier Linux}{2024 -- 2025}
...
\item Rédige et maintient un guide complet d’installation Linux (VM, double amorçage, pilotes,\\ réseau, etc) {\small \href{https://github.com/George-Fam/LinuxInstallGuide}{\faGithubSquare\ George-Fam/LinuxInstallGuide}}
