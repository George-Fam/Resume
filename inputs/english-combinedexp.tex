...
\begin{document}
 ...
 %----------------------------%
  ...
  \headingBf{Linux Workshop Facilitator}{2024 -- 2025}
  \headingIt{UQÀM | Université de Québec à Montréal}{}
  \begin{resume_list}
    \item Guide users through Linux installation, configuration, and troubleshooting
    \item Write and maintain a comprehensive Linux installation guide for VM, dual boot, drivers, and networking {\small \href{https://github.com/George-Fam/LinuxInstallGuide}{\faGithubSquare\ George-Fam/LinuxInstallGuide}}
